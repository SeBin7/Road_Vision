...
class VideoInference:
    def __init__(self, seq_len=SEQ_LEN):
        ...
        torch.serialization.add_safe_globals([MobileNetFeatureExtractor])
        # self.cnn = torch.load("best_cnn_feature_extractor.pt", map_location=device, weights_only=False)
        # self.cls = torch.load("best_gru_mlp_classifier.pt", map_location=device, weights_only=False)
