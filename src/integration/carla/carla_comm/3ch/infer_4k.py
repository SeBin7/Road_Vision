...
from models.Mobilenet_hailo_3ch import MobileNetFeatureExtractor
...
class VideoInference:
    def __init__(self, seq_len=SEQ_LEN):
        ...
        self.cnn.load_state_dict(torch.load('./cnn_feature_extractor_3ch_val.pth',
                                            map_location=device))
        self.cls.load_state_dict(torch.load('./gru_mlp_classifier_3ch_val.pth',
                                            map_location=device))
        self.cnn.eval()
        self.cls.eval()
